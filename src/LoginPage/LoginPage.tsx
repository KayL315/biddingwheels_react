                    ...
                    <div className="d-flex flex-row align-items-center mb-2">
                      <div className="form-outline flex-fill mb-0">
                        <input
                          ...
                          onChange={(e) => setCredentials({ ...credentials, username: e.target.value })} // Connect onChange to handleInputChange
                        />
                      </div>
                    </div>
                    ...
                    <div className="d-flex flex-row align-items-center mb-2">
                      <div className="form-outline flex-fill mb-0">
                        <input
                          ...
                          onChange={(e) => setCredentials({ ...credentials, password: e.target.value })} // Connect onChange to handleInputChange
                        />
                        {error && <p style={{ color: "red" }}>The password must be at least 6 characters long</p>}
                      </div>
                    </div>
